...
process FeatureCount_intron
{
    ...
    '''
    featureCounts -a genes.gtf -L -t gene -g gene_name -o gene_assigned -s 1 -R CORE Aligned.sortedByCoord.out.bam
    '''
}
...
process FeatureCount_exon
{
    ...
    '''
    featureCounts -a genes.gtf -L -t exon -g gene_name -o gene_assigned -s 1 Aligned.sortedByCoord.out.bam
    '''
}
